...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2024 at 07:18 AM
...
CREATE TABLE `tbl_address` (
  ...
  `default_value` varchar(10) DEFAULT '0',
...
INSERT INTO `tbl_address` (`id`, `city`, `state`, `country`, `number`, `zipcode`, `user_id`, `default_value`, `firstname`, `lastname`, `address`) VALUES
(13, 'kota', 'rajasthan', 'Austria', '9166569690', '8787954', 11, '0', 'manu22', 'kumar', 'kota bajar'),
(17, 'mumbai', 'maharastra', 'India', '9144758290', '64646', 11, '1', 'akshay', 'kumar', 'mumbai bandra'),
(19, 'hyhyhy', 'yhyhyhyh', 'Argentina', 'yhyhyhyyhy', '6549549', 11, '0', 'byyhyhyhy', 'gour', 'yhyhyhyhyh'),
(20, 'hyh6tytyhythyth', 'gegtgg', 'Algeria', 'gtgtgtgtgt', '554949', 11, '0', 'salman', 'yghtygtygtygty', 'gtgtgtgtg');
...
CREATE TABLE `tbl_customer` (
  ...
  `customer_other_phone` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tbl_customer` (`customer_id`, `customer_name`, `customer_email`, `customer_password`, `customer_address`, `customer_city`, `customer_zipcode`, `customer_phone`, `customer_country`, `customer_active`, `customer_other_phone`) VALUES
(9, 'Christine', 'christine@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', '458 Ralph Street', 'DEMO', '12500', '7458450000', 'Afghanistan', 1, NULL),
(10, 'Bob Gardin', 'bobg@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', '3556 Denver Avenue', 'Miram Loma', '3006', '7850002580', 'Australia', 1, NULL),
(11, 'sahil gour', 'sahilgour5675@gmail.com', '1dfdb52916d7cbffcf214e9efa3dcc4b', 'rajasthan sikar', 'sikar', '332001', '6376646300', 'USA', 0, '9166586590');
...
(10, 12, 7, 'Mountain Rain Jacket', 16850, 2, 'Five_Ten_Bike_All-Mountain_Rain_Jacket_Green_GP7212_21_'),
(11, 12, 8, 'Galaxy Buds Pro', 29550, 1, 'budspro.jpg');
...
(13, 0, 'rajav ', 'rajav121@gmail.com', 'rajasthan udaipur', 'updipur', 'USA', '9166569390', '33205'),
(14, 11, 'manu kumar', 'sahilgour5675@gmail.com', 'sikar rajasthan mohalla roshan ganj', 'sikar', 'india', '6376646300', '332001'),
(15, 11, 'shahrukh khan', 'sahilgour5255675@gmail.com', 'bajaj road ', 'sikar', 'India', '9155659390', '6956959'),
(16, 11, 'shahrukh khan', 'sahilgour66655675@gmail.com', 'bajaj road ', 'sikar', 'India', '9155659390', '6956959'),
(17, 11, 'shahrukh khan', 'sahilgour5675@gmail.com', 'bajaj road ', 'sikar', 'India', '9155659390', '6956959');
...
--
ALTER TABLE `tbl_address`
  ADD CONSTRAINT `tbl_address_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_customer` (`customer_id`);
COMMIT;
