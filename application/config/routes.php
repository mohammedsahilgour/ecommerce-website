...
// Address route
$route['Addressdata']             = 'Web/Addressdata';
$route['Addresslist']             = 'Web/Addresslist';
$route['updateadressdata']             = 'Web/updateadressdata';
$route['Addressdataupdate']             = 'Web/Addressdataupdate';
$route['deleteadressdata']             = 'Web/deleteadressdata';
...
$route['Address']             = 'web/Address';
$route['customereview']             = 'web/customereview';
$route['privacypolicy']             = 'web/privacypolicy';
$route['cart']                = 'web/cart';
