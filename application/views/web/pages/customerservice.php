        ...
        <div class="support">
            <div class="support_desc">
                ...
                <!-- <p><?php echo get_option('contact_subtitle');?></p> -->
                 <p>
                 "Passionate about delivering exceptional customer service with empathy and efficiency."</p>
                <!-- <p><?php echo get_option('contact_description');?></p> -->
                 <p>
                 "Exceptional customer service is our commitment to ensuring your satisfaction every step of the way."</p>
            </div>
            <img src="<?php echo base_url()?>assets/web/images/cs2.jpeg" alt="" class="customerserviceimg" />
            <div class="clear"></div>
        </div>
