  ...
  <table id="table=data"> 
           ...
           <?php foreach($address_data as $data){?>
            ...
            <?php  if($data['default_value']){?>
             ...
             <td class="default-address-td default-value-show"> <?php echo  "<button class='default-btn' id='default-yes-btn'> Yes </button>"?><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
